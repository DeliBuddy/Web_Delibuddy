...
const Shop = () => {
  ...
  return (
    <div>
        <div className='md:block hidden mt-10 ml-10'>
    ...
    <div className="flex flex-wrap gap-16 justify-center mt-10 px-10 w-full mx-auto ">
      {shops.map((shop, index) => (
          <div className="flex flex-row md:flex-col w-4/5 md:w-auto justify-start gap-4 items-center  bg-gradient-to-bl from-[#070707] from-0% to-[#222222] to-31% py-4 px-4 rounded-xl " key={index}>
